...
class EquipmentSeeder extends Seeder
{
     ...
     * into the current tenant database.
     */
    public function run(): void
    {
        ...
        // Seed student users
        foreach ([
            ['name' => 'Juan dela Cruz',  'email' => 'juan@'.$domain.'.com'],
            ['name' => 'Maria Santos',    'email' => 'maria@'.$domain.'.com'],
            ['name' => 'Pedro Reyes',     'email' => 'pedro@'.$domain.'.com'],
        ] as $student) {
            User::updateOrCreate(
                ['email' => $student['email']],
                [
        ...
        $this->command->info('Equipment seeder complete for '.$domain.'.');
        $this->command->info('Staff:   staff@'.$domain.'.com / staff123');
        $this->command->info('Student: juan@'.$domain.'.com / student123');
    }
}
