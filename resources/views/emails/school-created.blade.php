...
<head>  
    ...
    <title>Your School Has Been Created — Borrowix</title>
                                ...
                                <tr>
                                    <td style="background: linear-gradient(135deg, #111110 0%, #2a2a28 100%); padding: 48px 48px 40px;">
                                        ...
                                        <h1 style="margin: 0 0 10px; font-family: 'DM Serif Display', Georgia, serif; font-size: 32px; font-weight: 400; color: #ffffff; line-height: 1.2; letter-spacing: -0.3px;">
                                            Your school is<br>ready to go.
                                        </h1>
                                        <p style="margin: 0; font-size: 15px; color: rgba(255,255,255,0.55); line-height: 1.6;">
                                            Welcome to Borrowix — your account has been created.<br>Set your password to get started.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 36px 48px 0;">
                                        ...
                                        <p style="margin: 0 0 20px; font-size: 11px; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: #9b9b93;">Account Details</p>
                                        ...
                                        <!-- Row 3: School Portal + Login — side by side -->
                                        <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 32px;">
                                            <tr>
                                                <td width="50%" style="vertical-align: top; padding-right: 16px;">
                                                    <p style="margin: 0 0 3px; font-size: 11px; font-weight: 500; letter-spacing: 0.06em; text-transform: uppercase; color: #b0b0a8;">School Portal</p>
                                                    <a href="{{ $subdomainUrl }}" style="font-size: 14px; font-weight: 600; color: #2563eb; text-decoration: none;">{{ $subdomainUrl }}</a>
                                                </td>
                                                <td width="50%" style="vertical-align: top;">
                                                    <p style="margin: 0 0 3px; font-size: 11px; font-weight: 500; letter-spacing: 0.06em; text-transform: uppercase; color: #b0b0a8;">Login Page</p>
                                                    <a href="{{ $loginUrl }}" style="font-size: 14px; font-weight: 600; color: #2563eb; text-decoration: none;">{{ $loginUrl }}</a>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td style="background-color: #F7F7F3; border-top: 1px solid #EBEBE5; padding: 28px 48px 32px;">
                                        <p style="margin: 0 0 20px; font-size: 14px; color: #6b6b63; line-height: 1.6;">
                                            Click below to set up your password and access your school dashboard. This link is valid for <strong style="color: #111110;">60 minutes</strong>.
                                        </p>
                                        <a href="{{ $resetLink }}" style="display: inline-block; background-color: #111110; color: #ffffff; font-family: 'DM Sans', sans-serif; font-size: 14px; font-weight: 600; text-decoration: none; padding: 14px 28px; border-radius: 8px; letter-spacing: 0.02em;">
                                            Set Up Your Password →
                                        </a>
                                        <p style="margin: 16px 0 0; font-size: 12px; color: #a0a099;">
                                            Link expired? Use <strong>"Forgot Password"</strong> on the login page to request a new one.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <p style="margin: 0; font-size: 12px; color: #b8b8b0;">
                                            This email was sent because a new school account was created.
                                        </p>
                                    </td>
                                </tr>
                            </table>
