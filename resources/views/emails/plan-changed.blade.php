...
<head>  
    ...
    <title>Your Subscription Has Been Updated — Borrowix</title>
                                ...
                                <tr>
                                    <td style="background: linear-gradient(135deg, #111110 0%, #2a2a28 100%); padding: 48px 48px 40px;">
                                        ...
                                        <h1 style="margin: 0 0 10px; font-family: 'DM Serif Display', Georgia, serif; font-size: 32px; font-weight: 400; color: #ffffff; line-height: 1.2; letter-spacing: -0.3px;">
                                            Your subscription has<br>been updated.
                                        </h1>
                                        <p style="margin: 0; font-size: 15px; color: rgba(255,255,255,0.55); line-height: 1.6;">
                                            Your plan has been changed by the Borrowix team.<br>Review the details below.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 36px 48px 0;">
                                        ...
                                        <!-- Label: Plan Change -->
                                        <p style="margin: 0 0 20px; font-size: 11px; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: #9b9b93;">Plan Change</p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #F0F0EC; padding-bottom: 16px; margin-bottom: 16px;">
                                            <tr>
                                                <td>
                                                    <p style="margin: 0 0 3px; font-size: 11px; font-weight: 500; letter-spacing: 0.06em; text-transform: uppercase; color: #b0b0a8;">Plan Changed</p>
                                                    <p style="margin: 0; font-size: 16px; font-weight: 600; color: #111110;">
                                                        {{ ucfirst($oldPlan) }} → {{ ucfirst($newPlan) }}
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td style="background-color: #F7F7F3; border-top: 1px solid #EBEBE5; padding: 28px 48px 32px;">
                                        <p style="margin: 0; font-size: 14px; color: #6b6b63; line-height: 1.6;">
                                            If you have questions about your new plan or believe this change was made in error, please contact our support team.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <p style="margin: 0; font-size: 12px; color: #b8b8b0;">
                                            This email was sent because your subscription plan was updated.
                                        </p>
                                    </td>
                                </tr>
                            </table>
