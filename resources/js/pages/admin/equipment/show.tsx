    ...
    return (
        <AdminLayout breadcrumbs={breadcrumbs}>
            ...
            >
                <PageHeader
                    title={e.name}
                    description={[e.brand, e.model].filter(Boolean).join(' · ') || 'Equipment Details'}
                    actions={
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-4">
                    ...
                    <StatCard
                        ...
                        valueColor={e.available_quantity > 0 ? 'hsl(var(--primary))' : 'hsl(var(--destructive))'}
                        delay={0.05}
                    />
                    <StatCard title="Borrowed" value={e.quantity - e.available_quantity} delay={0.1} />
                    <StatCard title="Total Borrows" value={e.borrow_transactions_count} delay={0.15} />
                </div>
                    ...
                    <div className="space-y-4">
                        ...
                        {e.image && (
                            <Card>
                                ...
                                <CardContent>
                                    <img src={e.image} alt={e.name} className="w-full h-auto rounded-lg border object-cover shadow-sm" />
                                </CardContent>
                            </Card>
                        )}
